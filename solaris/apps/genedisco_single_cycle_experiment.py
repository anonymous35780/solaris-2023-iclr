...
from solaris.models import meta_models
from solaris.models import pytorch_models
...
#from solaris.data.ccle_protein_quantification import CCLEProteinQuantification
...
class SingleCycleApplication(aba.AbstractBaseApplication):
    DATASET_NAMES = [
        "schmidt_2021_ifng","schmidt_2021_il2", "zhuang_2019_nk","sanchez_2021_tau", "zhu_2021_sarscov2"
    ]
    ...
    def __init__(
        ...
        self.ignore_param_names = ["available_indices",
                              "selected_indices",
                              "test_indices"]
        ...
        super(SingleCycleApplication, self).__init__(
            ...
            seed=seed,
            #ignore_param_names=ignore_param_names,
    ...
    def get_model(self, **kwargs):
        if self.model_name == "gp":
            ...
            sp_model = toy_experiment_models.BayesianLinearModel(
                input_dims = SingleCycleApplication.get_dataset_x(self.feature_set_name,self.cache_directory).get_shape()[0][-1], 
    ...
    def get_model_hyperparameter_ranges(self) -> Dict[AnyStr, Union[AnyStr, int]]:
        ...
        Returns:
            ...
            (represented as a Tuple) or continuous (represented as a List[start, end]) value range.
        """
        prefixes = {"randomforest": "rf_", "bayesian_mlp": "dn_", "linear": "lbm_", "gp": "gp_"}
